...
export class UserService {
  ...
  */
  ...
  deleteUser(userId) {
    ...
    return this.http.delete(`${this.baseUrl}/deleteUser/${userId}`, this.options).pipe(
      catchError(this.errorHandler)
    );
  }
  ...
  userLoginByuname(user):Observable<any> {
    console.log(JSON.stringify(user));
    return this.http
      .post<any>(this.baseUrl + "/userLoginByuname", JSON.stringify(user), this.options)
      .pipe(catchError(this.errorHandler));
  }
